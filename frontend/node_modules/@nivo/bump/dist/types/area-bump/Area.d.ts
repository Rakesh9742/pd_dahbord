...
export declare const Area: <Datum extends AreaBumpDatum, ExtraProps extends AreaBumpSerieExtraProps>({ serie, areaGenerator, blendMode, isInteractive, onMouseEnter, onMouseMove, onMouseLeave, onClick, setActiveSerieIds, tooltip, }: AreaProps<Datum, ExtraProps>) => import("react/jsx-runtime").JSX.Element;
export {};
