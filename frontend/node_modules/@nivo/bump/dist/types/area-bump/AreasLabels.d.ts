...
export declare const AreasLabels: <Datum extends AreaBumpDatum, ExtraProps extends AreaBumpSerieExtraProps>({ getLabel, series, position, padding, color, }: AreaLabelsProps<Datum, ExtraProps>) => import("react/jsx-runtime").JSX.Element;
export {};
