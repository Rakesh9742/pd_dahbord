...
export declare const LinesLabels: <Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps>({ series, getLabel, position, padding, color, }: LineLabelsProps<Datum, ExtraProps>) => import("react/jsx-runtime").JSX.Element;
export {};
