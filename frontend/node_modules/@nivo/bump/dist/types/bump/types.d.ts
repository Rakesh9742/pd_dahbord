...
export type BumpMouseHandler<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = BumpSerieMouseHandler<Datum, ExtraProps> | BumpPointMouseHandler<Datum, ExtraProps>;
...
interface BumpPointMouseHandlersProps<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> {
    useMesh: true;
...
interface BumpSeriesMouseHandlersProps<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> {
    useMesh?: false;
...
export type BumpSvgPropsWithSeriesMouseHandlers<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = Dimensions & BumpDataProps<Datum, ExtraProps> & Partial<BumpCommonProps<Datum, ExtraProps>> & BumpSeriesMouseHandlersProps<Datum, ExtraProps> & Partial<BumpSvgExtraProps<Datum, ExtraProps>> & MotionProps;
export type BumpSvgPropsWithPointMouseHandlers<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = Dimensions & BumpDataProps<Datum, ExtraProps> & Partial<BumpCommonProps<Datum, ExtraProps>> & BumpPointMouseHandlersProps<Datum, ExtraProps> & Partial<BumpSvgExtraProps<Datum, ExtraProps>> & MotionProps;
export type BumpSvgProps<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps = Record<string, unknown>> = BumpSvgPropsWithSeriesMouseHandlers<Datum, ExtraProps> | BumpSvgPropsWithPointMouseHandlers<Datum, ExtraProps>;
export type BumpSvgPropsWithDefaults<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = Dimensions & BumpDataProps<Datum, ExtraProps> & BumpCommonProps<Datum, ExtraProps> & (BumpSeriesMouseHandlersProps<Datum, ExtraProps> | BumpPointMouseHandlersProps<Datum, ExtraProps>) & BumpSvgExtraProps<Datum, ExtraProps> & MotionProps;
export {};
