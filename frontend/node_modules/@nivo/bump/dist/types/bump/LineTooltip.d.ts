...
export declare const LineTooltip: <Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps>({ serie, }: LineTooltipProps<Datum, ExtraProps>) => import("react/jsx-runtime").JSX.Element;
export {};
