...
declare const _default: import("react").MemoExoticComponent<(<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps>({ point, }: PointTooltipProps<Datum, ExtraProps>) => import("react/jsx-runtime").JSX.Element)>;
