...
export declare const Point: <Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps>({ point, }: PointProps<Datum, ExtraProps>) => import("react/jsx-runtime").JSX.Element;
